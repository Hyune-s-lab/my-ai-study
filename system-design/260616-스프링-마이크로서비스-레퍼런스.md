...
> 출처: 『스프링 마이크로서비스 코딩 공작소』 종합 예제. **D2 + simpleicons → PNG**. 생성: [`assets/스프링-마이크로서비스-레퍼런스.d2`](./assets/스프링-마이크로서비스-레퍼런스.d2). 멀티벤더라 simpleicons(플랫 단색 글리프)로 통일, Zipkin은 박스. 흐름·개념은 그림 안 범례·메모 참고.
