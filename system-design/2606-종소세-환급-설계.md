...
![종소세 환급 MVP의 잡 처리 흐름](assets/2606-종소세-환급-설계-mvp.svg)
...
![종소세 환급 서비스의 운영 구조](assets/2606-종소세-환급-설계-production.svg)
...
%%{init: {"flowchart": {"curve": "stepAfter", "wrappingWidth": 400}}}%%
  ...
  n_RULESET["RULESET"]
  n_FILING["FILING"]
  n_USERS -->|"1 : 0..N 요청"| n_ESTIMATE
  n_RULESET -->|"1 : 0..N 계산"| n_ESTIMATE
  n_USERS -->|"1 : 0..N 제출"| n_FILING
  n_ESTIMATE -->|"1 : 0..N 근거"| n_FILING
```
...
%%{init: {"flowchart": {"curve": "stepAfter", "wrappingWidth": 400}}}%%
  ...
  n_CLAIM["CLAIM"]
  n_FILING["FILING"]
  n_USERS -->|"1 : 0..N 동의 기록"| n_CONSENT
  n_USERS -->|"1 : 0..N 청구"| n_CLAIM
  n_FILING -->|"1 : 0..N 근거"| n_CLAIM
```
